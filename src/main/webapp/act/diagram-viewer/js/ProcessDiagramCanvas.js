...
// Colors
var TASK_COLOR = Color.get(222, 248, 255);//Color.OldLace; // original: Color.get(255, 255, 204);
var TASK_STROKE_COLOR = Color.SlateGrey;//Color.black; /*Color.SlateGrey; */
...
var HIGHLIGHT_COLOR = Color.Green3;//Color.Firebrick1;
